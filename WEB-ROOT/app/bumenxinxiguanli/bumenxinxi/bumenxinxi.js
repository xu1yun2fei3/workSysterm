...
{xtype : 'textfield',
fieldLabel : '部门名称',
name : 'bumenmingchenSearch',
id : 'bumenmingchenSearch',
anchor : '100%'
} ]}
,
{
...
{xtype : 'textfield',
fieldLabel : '上级部门',
name : 'shangjibumenSearch',
id : 'shangjibumenSearch',
anchor : '100%'
} ]}
,
{
...
{xtype : 'textfield',
fieldLabel : '部门负责人',
name : 'bumenfuzerenSearch',
id : 'bumenfuzerenSearch',
anchor : '100%'
} ]}
,
{
...
{xtype : 'textfield',
fieldLabel : '编制人数',
name : 'bianzhirenshuSearch',
id : 'bianzhirenshuSearch',
anchor : '100%'
} ]}
,
{
...
{xtype : 'textfield',
fieldLabel : '部门描述',
name : 'bumenmiaoshuSearch',
id : 'bumenmiaoshuSearch',
anchor : '100%'
} ]}
,
{
...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataStore = new Ext.data.JsonStore( {
		...
		remoteSort : true,
		fields : [ 'bumenmingchen','shangjibumen','bumenzhize','chenglishijian','bumenfuzeren','bianzhirenshu','bumenmiaoshu','id','itime','detail','deleteFlag','erjiguanlianzd','attr1','attr2','attr3','attr4','attr5' ],
		proxy : new Ext.data.HttpProxy( {
			url : '/WEB-ROOT/app/bumenxinxiguanli/bumenxinxi.do',
			method : 'POST'
		}),
		baseParams : {
			flag : 'getJsonStore',
...
{
header : '<font color="blue">部门职责</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'bumenzhize'
}, 
{
header : '<font color="blue">成立时间</font>',
width : 60,
align : 'center',
sortable : true,
...
{
header : '<font color="blue">编制人数</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'bianzhirenshu'
}, 
{
header : '<font color="blue">部门描述</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'bumenmiaoshu'
}, 
...
ManageObj.doSearch = function() {
	...
	ManageObj.dataStore.baseParams.bumenmingchenSearch = document.all.bumenmingchenSearch.value; 
ManageObj.dataStore.baseParams.shangjibumenSearch = document.all.shangjibumenSearch.value; 
ManageObj.dataStore.baseParams.bumenzhizeSearch = document.all.bumenzhizeSearch.value; 
ManageObj.dataStore.baseParams.chenglishijianSearch = document.all.chenglishijianSearch.value; 
ManageObj.dataStore.baseParams.bumenfuzerenSearch = document.all.bumenfuzerenSearch.value; 
ManageObj.dataStore.baseParams.bianzhirenshuSearch = document.all.bianzhirenshuSearch.value; 
ManageObj.dataStore.baseParams.bumenmiaoshuSearch = document.all.bumenmiaoshuSearch.value; 
...
items : [ {
xtype : 'textarea',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;部门职责',
name : 'bumenzhize',
id : 'bumenzhize',
anchor : '95%',
allowBlank : false
...
xtype : 'datefield',
format : 'Y-m-d',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;成立时间',
name : 'chenglishijian',
id : 'chenglishijian',
anchor : '95%',
allowBlank : false
...
items : [ {
xtype : 'textfield',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;编制人数',
name : 'bianzhirenshu',
id : 'bianzhirenshu',
anchor : '95%',
allowBlank : false
...
items : [ {
xtype : 'textarea',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;部门描述',
name : 'bumenmiaoshu',
id : 'bumenmiaoshu',
anchor : '95%',
allowBlank : false
...
,{
	...
	if (rowIndex != null) {
		ManageObj.operationFormPan.findById('bumenmingchen').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('bumenmingchen');
ManageObj.operationFormPan.findById('shangjibumen').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('shangjibumen');
ManageObj.operationFormPan.findById('bumenzhize').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('bumenzhize');
...
ManageObj.operationFormPan.findById('bumenfuzeren').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('bumenfuzeren');
ManageObj.operationFormPan.findById('bianzhirenshu').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('bianzhirenshu');
ManageObj.operationFormPan.findById('bumenmiaoshu').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('bumenmiaoshu');
...
ManageObj.doExportExcel = function() {
	var url = "/WEB-ROOT/app/bumenxinxiguanli/bumenxinxi.do?flag=doExportExcel";
	window.open(  url );
};
