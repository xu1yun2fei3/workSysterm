...
ManageObj.yuangongidGuanLianStore = new Ext.data.JsonStore({
url : '/WEB-ROOT/app/yuangongxinxiguanli/yuangongxinxi.do',
baseParams : {
flag : 'doGuanLian',
...
ManageObj.xingbieGuanLianStore = new Ext.data.JsonStore({
url : '/WEB-ROOT/app/yuangongxinxiguanli/yuangongxinxi.do',
baseParams : {
flag : 'doGuanLian',
guanLianBiao : 'tabf_gender',
guanLianZiDuan : 'descr'
},
root : 'root',
totalProperty : 'totalProperty',
fields : ['descr']
...
ManageObj.suozaibumenGuanLianStore = new Ext.data.JsonStore({
url : '/WEB-ROOT/app/yuangongxinxiguanli/yuangongxinxi.do',
baseParams : {
flag : 'doGuanLian',
guanLianBiao : 'bumenxinxi',
guanLianZiDuan : 'bumenmingchen'
},
root : 'root',
totalProperty : 'totalProperty',
fields : ['bumenmingchen']
});

ManageObj.suozaigangweiGuanLianStore = new Ext.data.JsonStore({
url : '/WEB-ROOT/app/yuangongxinxiguanli/yuangongxinxi.do',
baseParams : {
flag : 'doGuanLian',
guanLianBiao : 'gangweishezhi',
guanLianZiDuan : 'gangweimingchen'
},
root : 'root',
totalProperty : 'totalProperty',
fields : ['gangweimingchen']
});
...
{xtype : 'textfield',
fieldLabel : '所在部门',
name : 'suozaibumenSearch',
id : 'suozaibumenSearch',
anchor : '100%'
} ]}
,
{
...
{xtype : 'textfield',
fieldLabel : '所在岗位',
name : 'suozaigangweiSearch',
id : 'suozaigangweiSearch',
anchor : '100%'
} ]}
,
{
...
{xtype : 'textfield',
fieldLabel : '个人简历',
name : 'gerenjianliSearch',
id : 'gerenjianliSearch',
anchor : '100%'
} ]}
,
{
...
{xtype : 'textfield',
fieldLabel : '联系方式',
name : 'lianxifangshiSearch',
id : 'lianxifangshiSearch',
anchor : '100%'
} ]}
  ]
		} ],
...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataStore = new Ext.data.JsonStore( {
		...
		totalProperty : 'totalProperty',
		remoteSort : true,
		fields : [ 'yuangongid','gonghao','xingming','xingbie','ruzhishijian','suozaibumen','suozaigangwei','gerenjianli','lianxifangshi','id','itime','detail','deleteFlag','erjiguanlianzd','attr1','attr2','attr3','attr4','attr5','fuJian' ],
	...
	*/
	...
	ManageObj.dataGridPan = new Ext.grid.GridPanel( {
		...
		*/
		{
header : '<font color="blue">员工ID</font>',
width : 60,
align : 'center',
sortable : true,
...
{
header : '<font color="blue">工号</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'gonghao'
...
{
header : '<font color="blue">姓名</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'xingming'
...
{
header : '<font color="blue">所在部门</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'suozaibumen'
}, 
{
header : '<font color="blue">所在岗位</font>',
width : 60,
align : 'center',
sortable : true,
...
{
header : '<font color="blue">个人简历</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'gerenjianli'
}, 
{
header : '<font color="blue">联系方式</font>',
width : 60,
align : 'center',
sortable : true,
...
ManageObj.doSearch = function() {
	...
	ManageObj.dataStore.baseParams.yuangongidSearch = document.all.yuangongidSearch.value; 
ManageObj.dataStore.baseParams.gonghaoSearch = document.all.gonghaoSearch.value; 
ManageObj.dataStore.baseParams.xingmingSearch = document.all.xingmingSearch.value; 
...
ManageObj.dataStore.baseParams.suozaibumenSearch = document.all.suozaibumenSearch.value; 
ManageObj.dataStore.baseParams.suozaigangweiSearch = document.all.suozaigangweiSearch.value; 
ManageObj.dataStore.baseParams.gerenjianliSearch = document.all.gerenjianliSearch.value; 
ManageObj.dataStore.baseParams.lianxifangshiSearch = document.all.lianxifangshiSearch.value; 
...
items : [ {
xtype : 'combo',
fieldLabel : '<font color="red">*</font>&nbsp;员工ID',
store : ManageObj.yuangongidGuanLianStore,
valueField : 'userAcct',
displayField : 'userAcct',
mode : 'remote',
forceSelection : false,
hiddenName : 'yuangongidHidd',
triggerAction : 'all',
editable : true,
name : 'yuangongid',
id : 'yuangongid',
...
store : ManageObj.xingbieGuanLianStore,
valueField : 'descr',
displayField : 'descr',
mode : 'remote',
forceSelection : false,
hiddenName : 'xingbieHidd',
triggerAction : 'all',
editable : true,
name : 'xingbie',
id : 'xingbie',
...
items : [ {
xtype : 'combo',
fieldLabel : '<font color="red">*</font>&nbsp;所在部门',
store : ManageObj.suozaibumenGuanLianStore,
valueField : 'bumenmingchen',
displayField : 'bumenmingchen',
mode : 'remote',
forceSelection : false,
hiddenName : 'suozaibumenHidd',
triggerAction : 'all',
editable : true,
name : 'suozaibumen',
id : 'suozaibumen',
...
items : [ {
xtype : 'combo',
fieldLabel : '<font color="red">*</font>&nbsp;所在岗位',
store : ManageObj.suozaigangweiGuanLianStore,
valueField : 'gangweimingchen',
displayField : 'gangweimingchen',
mode : 'remote',
forceSelection : false,
hiddenName : 'suozaigangweiHidd',
triggerAction : 'all',
editable : true,
name : 'suozaigangwei',
id : 'suozaigangwei',
...
items : [ {
xtype : 'textarea',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;个人简历',
name : 'gerenjianli',
id : 'gerenjianli',
anchor : '95%',
allowBlank : false
...
items : [ {
xtype : 'textarea',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;联系方式',
name : 'lianxifangshi',
id : 'lianxifangshi',
anchor : '95%',
allowBlank : false
...
,{
	...
	if (rowIndex != null) {
		ManageObj.operationFormPan.findById('yuangongid').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('yuangongid');
ManageObj.operationFormPan.findById('gonghao').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('gonghao');
ManageObj.operationFormPan.findById('xingming').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('xingming');
ManageObj.operationFormPan.findById('xingbie').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('xingbie');
ManageObj.operationFormPan.findById('ruzhishijian').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('ruzhishijian');
ManageObj.operationFormPan.findById('suozaibumen').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('suozaibumen');
ManageObj.operationFormPan.findById('suozaigangwei').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('suozaigangwei');
ManageObj.operationFormPan.findById('gerenjianli').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('gerenjianli');
ManageObj.operationFormPan.findById('lianxifangshi').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('lianxifangshi');
...
ManageObj.doExportExcel = function() {
	var url = "/WEB-ROOT/app/yuangongxinxiguanli/yuangongxinxi.do?flag=doExportExcel";
	window.open(  url );
};
