...
fieldLabel : '评论标题',
name : 'pinglunbiaotiSearch',
id : 'pinglunbiaotiSearch',
anchor : '100%'
} ]}
,
{
...
{xtype : 'textfield',
fieldLabel : '评论内容',
name : 'pinglunnarongSearch',
id : 'pinglunnarongSearch',
anchor : '100%'
} ]}
,
{
...
{xtype : 'datefield',
fieldLabel : '评论时间',
name : 'pinglunshijianSearch',
id : 'pinglunshijianSearch',
anchor : '100%'
} ]}
  ]
		} ],
...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataStore = new Ext.data.JsonStore( {
		...
		remoteSort : true,
		fields : [ 'pinglunbiaoti','pinglunnarong','pinglunren','pinglunshijian','id','itime','detail','deleteFlag','erjiguanlianzd','fuJian' ],
		proxy : new Ext.data.HttpProxy( {
			url : '/WEB-ROOT/app/pinglunpingjiaguanli/wodepinglun.do',
			method : 'POST'
		}),
		baseParams : {
			flag : 'getJsonStore',
	...
	*/
	...
	ManageObj.dataGridPan = new Ext.grid.GridPanel( {
		...
		, {
header : '<font color="blue">评论标题</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'pinglunbiaoti'
} 
, {
header : '<font color="blue">评论内容</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'pinglunnarong'
} 
, {
header : '<font color="blue">评论人</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'pinglunren'
} 
, {
header : '<font color="blue">评论时间</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'pinglunshijian'
} 
, {
...
ManageObj.doSearch = function() {
	...
	ManageObj.dataStore.baseParams.pinglunbiaotiSearch = document.all.pinglunbiaotiSearch.value; 
ManageObj.dataStore.baseParams.pinglunnarongSearch = document.all.pinglunnarongSearch.value; 
ManageObj.dataStore.baseParams.pinglunrenSearch = document.all.pinglunrenSearch.value; 
ManageObj.dataStore.baseParams.pinglunshijianSearch = document.all.pinglunshijianSearch.value; 
...
items : [ {
xtype : 'textfield',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;评论标题',
name : 'pinglunbiaoti',
id : 'pinglunbiaoti',
anchor : '95%',
allowBlank : false
...
items : [ {
xtype : 'textarea',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;评论内容',
name : 'pinglunnarong',
id : 'pinglunnarong',
anchor : '95%',
allowBlank : false
...
items : [ {
xtype : 'textfield',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;评论人',
name : 'pinglunren',
id : 'pinglunren',
anchor : '95%',
readOnly:true,
...
xtype : 'datefield',
format : 'Y-m-d',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;评论时间',
name : 'pinglunshijian',
id : 'pinglunshijian',
anchor : '95%',
readOnly:true,
...
,{
	...
	if (rowIndex != null) {
		ManageObj.operationFormPan.findById('pinglunbiaoti').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('pinglunbiaoti');
ManageObj.operationFormPan.findById('pinglunnarong').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('pinglunnarong');
ManageObj.operationFormPan.findById('pinglunren').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('pinglunren');
ManageObj.operationFormPan.findById('pinglunshijian').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('pinglunshijian');
...
ManageObj.doExportExcel = function() {
	var url = "/WEB-ROOT/app/pinglunpingjiaguanli/wodepinglun.do?flag=doExportExcel";
	window.open(  url );
};
