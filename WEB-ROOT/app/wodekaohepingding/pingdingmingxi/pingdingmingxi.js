...
url : '/WEB-ROOT/app/wodekaohepingding/pingdingmingxi.do',
baseParams : {
flag : 'doGuanLian',
guanLianBiao : 'kaopingxiangmushezhi',
guanLianZiDuan : 'kaopingxiangmingchen'
},
root : 'root',
totalProperty : 'totalProperty',
fields : ['kaopingxiangmingchen']
});

ManageObj.kaopingfenshuGuanLianStore = new Ext.data.JsonStore({
url : '/WEB-ROOT/app/wodekaohepingding/pingdingmingxi.do',
baseParams : {
flag : 'doGuanLian',
guanLianBiao : 'pingdingfenshu',
guanLianZiDuan : 'pingdingfenshu'
},
root : 'root',
totalProperty : 'totalProperty',
fields : ['pingdingfenshu']
});
...
{xtype : 'textfield',
fieldLabel : '得分说明',
name : 'defenshuomingSearch',
id : 'defenshuomingSearch',
anchor : '100%'
} ]}
,
{
...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataStore = new Ext.data.JsonStore( {
		...
		totalProperty : 'totalProperty',
		remoteSort : true,
		fields : [ 'kaopingxiangmu','kaopingfenshu','defenshuoming','id','itime','detail','deleteFlag','erjiguanlianzd','attr1','attr2','attr3','attr4','attr5' ],
	...
	*/
	...
	ManageObj.dataGridPan = new Ext.grid.GridPanel( {
		...
		*/
		{
header : '<font color="blue">考评项目</font>',
width : 60,
align : 'center',
sortable : true,
...
{
header : '<font color="blue">考评分数</font>',
width : 60,
align : 'center',
sortable : true,
...
{
header : '<font color="blue">得分说明</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'defenshuoming'
}, 
...
ManageObj.dataStore.baseParams.defenshuomingSearch = document.all.defenshuomingSearch.value; 
...
items : [ {
xtype : 'combo',
fieldLabel : '<font color="red">*</font>&nbsp;考评项目',
store : ManageObj.kaopingxiangmuGuanLianStore,
valueField : 'kaopingxiangmingchen',
displayField : 'kaopingxiangmingchen',
mode : 'remote',
...
items : [ {
xtype : 'combo',
fieldLabel : '<font color="red">*</font>&nbsp;考评分数',
store : ManageObj.kaopingfenshuGuanLianStore,
valueField : 'pingdingfenshu',
displayField : 'pingdingfenshu',
mode : 'remote',
forceSelection : false,
hiddenName : 'kaopingfenshuHidd',
triggerAction : 'all',
editable : true,
name : 'kaopingfenshu',
id : 'kaopingfenshu',
...
items : [ {
xtype : 'textarea',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;得分说明',
name : 'defenshuoming',
id : 'defenshuoming',
anchor : '95%',
allowBlank : false
...
ManageObj.operationFormPan.findById('defenshuoming').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('defenshuoming');
...
ManageObj.doExportExcel = function() {
	var url = "/WEB-ROOT/app/wodekaohepingding/pingdingmingxi.do?flag=doExportExcel";
	window.open(  url );
};
