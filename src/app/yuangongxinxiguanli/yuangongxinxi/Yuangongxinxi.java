...
if( !SysInfo.getLoginUserType(request, response).equals("1") ){ 
	...
	public static WritableSheet refreashSheet(List<Object> al, WritableSheet ws) throws Exception {
       ...
       //样式5
		...
		// 设置表头(列号,行号 ,内容 )
		 Label label_0 = new Label(1, 3, "员工ID", wcfFC5);  
 ws.addCell(label_0); 
 Label label_1 = new Label(2, 3, "工号", wcfFC5);  
 ws.addCell(label_1); 
 Label label_2 = new Label(3, 3, "姓名", wcfFC5);  
 ws.addCell(label_2); 
 Label label_3 = new Label(4, 3, "性别", wcfFC5);  
 ws.addCell(label_3); 
 Label label_4 = new Label(5, 3, "入职时间", wcfFC5);  
 ws.addCell(label_4); 
 Label label_5 = new Label(6, 3, "所在部门", wcfFC5);  
 ws.addCell(label_5); 
 Label label_6 = new Label(7, 3, "所在岗位", wcfFC5);  
 ws.addCell(label_6); 
 Label label_7 = new Label(8, 3, "个人简历", wcfFC5);  
 ws.addCell(label_7); 
 Label label_8 = new Label(9, 3, "联系方式", wcfFC5);  
 ws.addCell(label_8); 
