...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataStore = new Ext.data.JsonStore( {
		...
		remoteSort : true,
		fields : [ 'pingdingdengji','id','itime','detail','deleteFlag','erjiguanlianzd','attr1','attr2','attr3','attr4','attr5' ],
		proxy : new Ext.data.HttpProxy( {
			url : '/WEB-ROOT/app/xitonggaojishezhi/pingdingdengji.do',
			method : 'POST'
		}),
		baseParams : {
			flag : 'getJsonStore',
...
ManageObj.doExportExcel = function() {
	var url = "/WEB-ROOT/app/xitonggaojishezhi/pingdingdengji.do?flag=doExportExcel";
	window.open(  url );
};
