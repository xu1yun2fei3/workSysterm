...
{xtype : 'textfield',
fieldLabel : '考评描述',
name : 'kaopingmiaoshuSearch',
id : 'kaopingmiaoshuSearch',
anchor : '100%'
} ]}
,
{
...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataStore = new Ext.data.JsonStore( {
		...
		remoteSort : true,
		fields : [ 'kaopingmingchen','kaopingmiaoshu','canyuren','tijiaoriqi','id','itime','detail','deleteFlag','erjiguanlianzd','attr1','attr2','attr3','attr4','attr5','fuJian' ],
		proxy : new Ext.data.HttpProxy( {
			url : '/WEB-ROOT/app/kaohepingdingguanli/kaohepingdingfabu.do',
			method : 'POST'
		}),
		baseParams : {
			flag : 'getJsonStore',
...
{
header : '<font color="blue">考评描述</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'kaopingmiaoshu'
}, 
{
header : '<font color="blue">参与人</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'canyuren'
...
{
header : '<font color="blue">提交日期</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'tijiaoriqi'
}, 
...
ManageObj.dataStore.baseParams.kaopingmiaoshuSearch = document.all.kaopingmiaoshuSearch.value; 
ManageObj.dataStore.baseParams.canyurenSearch = document.all.canyurenSearch.value; 
ManageObj.dataStore.baseParams.tijiaoriqiSearch = document.all.tijiaoriqiSearch.value; 
...
items : [ {
xtype : 'textarea',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;考评描述',
name : 'kaopingmiaoshu',
id : 'kaopingmiaoshu',
anchor : '95%',
allowBlank : false
...
items : [ {
xtype : 'textfield',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;参与人',
name : 'canyuren',
id : 'canyuren',
anchor : '95%',
allowBlank : false
...
xtype : 'datefield',
format : 'Y-m-d',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;提交日期',
name : 'tijiaoriqi',
id : 'tijiaoriqi',
anchor : '95%',
allowBlank : false
...
ManageObj.operationFormPan.findById('kaopingmiaoshu').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('kaopingmiaoshu');
ManageObj.operationFormPan.findById('canyuren').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('canyuren');
ManageObj.operationFormPan.findById('tijiaoriqi').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('tijiaoriqi');
...
ManageObj.doExportExcel = function() {
	var url = "/WEB-ROOT/app/kaohepingdingguanli/kaohepingdingfabu.do?flag=doExportExcel";
	window.open(  url );
};
