...
fieldLabel : '意见标题',
name : 'yijianbiaotiSearch',
id : 'yijianbiaotiSearch',
anchor : '100%'
} ]}
,
{
...
{xtype : 'textfield',
fieldLabel : '意见内容',
name : 'yijiannarongSearch',
id : 'yijiannarongSearch',
anchor : '100%'
} ]}
,
{
...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataStore = new Ext.data.JsonStore( {
		...
		remoteSort : true,
		fields : [ 'yijianbiaoti','yijiannarong','tijiaoren','tijiaoshijian','id','itime','detail','deleteFlag','erjiguanlianzd','fuJian' ],
		proxy : new Ext.data.HttpProxy( {
			url : '/WEB-ROOT/app/yijianxiangguanli/wodeyijianxiang.do',
			method : 'POST'
		}),
		baseParams : {
			flag : 'getJsonStore',
	...
	*/
	...
	ManageObj.dataGridPan = new Ext.grid.GridPanel( {
		...
		, {
header : '<font color="blue">意见标题</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'yijianbiaoti'
} 
, {
header : '<font color="blue">意见内容</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'yijiannarong'
} 
, {
...
ManageObj.doSearch = function() {
	...
	ManageObj.dataStore.baseParams.yijianbiaotiSearch = document.all.yijianbiaotiSearch.value; 
ManageObj.dataStore.baseParams.yijiannarongSearch = document.all.yijiannarongSearch.value; 
...
items : [ {
xtype : 'textfield',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;意见标题',
name : 'yijianbiaoti',
id : 'yijianbiaoti',
anchor : '95%',
allowBlank : false
...
items : [ {
xtype : 'textarea',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;意见内容',
name : 'yijiannarong',
id : 'yijiannarong',
anchor : '95%',
allowBlank : false
...
,{
	...
	if (rowIndex != null) {
		ManageObj.operationFormPan.findById('yijianbiaoti').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('yijianbiaoti');
ManageObj.operationFormPan.findById('yijiannarong').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('yijiannarong');
...
ManageObj.doExportExcel = function() {
	var url = "/WEB-ROOT/app/yijianxiangguanli/wodeyijianxiang.do?flag=doExportExcel";
	window.open(  url );
};
