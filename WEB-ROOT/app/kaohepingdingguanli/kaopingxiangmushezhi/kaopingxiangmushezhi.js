...
{xtype : 'textfield',
fieldLabel : '考评项名称',
name : 'kaopingxiangmingchenSearch',
id : 'kaopingxiangmingchenSearch',
anchor : '100%'
} ]}
,
{
...
{xtype : 'textfield',
fieldLabel : '考评标准',
name : 'kaopingbiaozhunSearch',
id : 'kaopingbiaozhunSearch',
anchor : '100%'
} ]}
,
{
...
{xtype : 'textfield',
fieldLabel : '考评说明',
name : 'kaopingshuomingSearch',
id : 'kaopingshuomingSearch',
anchor : '100%'
} ]}
,
{
...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataStore = new Ext.data.JsonStore( {
		...
		remoteSort : true,
		fields : [ 'kaopingxiangmingchen','kaopingbiaozhun','kaopingshuoming','zhidingren','id','itime','detail','deleteFlag','erjiguanlianzd','attr1','attr2','attr3','attr4','attr5','fuJian' ],
		proxy : new Ext.data.HttpProxy( {
			url : '/WEB-ROOT/app/kaohepingdingguanli/kaopingxiangmushezhi.do',
			method : 'POST'
		}),
		baseParams : {
			flag : 'getJsonStore',
	...
	*/
	...
	ManageObj.dataGridPan = new Ext.grid.GridPanel( {
		...
		*/
		{
header : '<font color="blue">考评项名称</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'kaopingxiangmingchen'
}, 
{
header : '<font color="blue">考评标准</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'kaopingbiaozhun'
}, 
{
header : '<font color="blue">考评说明</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'kaopingshuoming'
}, 
{
header : '<font color="blue">制定人</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'zhidingren'
}, 
...
ManageObj.doSearch = function() {
	...
	ManageObj.dataStore.baseParams.kaopingxiangmingchenSearch = document.all.kaopingxiangmingchenSearch.value; 
ManageObj.dataStore.baseParams.kaopingbiaozhunSearch = document.all.kaopingbiaozhunSearch.value; 
ManageObj.dataStore.baseParams.kaopingshuomingSearch = document.all.kaopingshuomingSearch.value; 
ManageObj.dataStore.baseParams.zhidingrenSearch = document.all.zhidingrenSearch.value; 
...
items : [ {
xtype : 'textfield',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;考评项名称',
name : 'kaopingxiangmingchen',
id : 'kaopingxiangmingchen',
anchor : '95%',
allowBlank : false
}]} 
,{
...
items : [ {
xtype : 'textarea',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;考评标准',
name : 'kaopingbiaozhun',
id : 'kaopingbiaozhun',
anchor : '95%',
allowBlank : false
}]} 
...
items : [ {
xtype : 'textarea',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;考评说明',
...
items : [ {
xtype : 'textarea',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;制定人',
name : 'zhidingren',
id : 'zhidingren',
anchor : '95%',
allowBlank : false
...
,{
	...
	if (rowIndex != null) {
		ManageObj.operationFormPan.findById('kaopingxiangmingchen').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('kaopingxiangmingchen');
ManageObj.operationFormPan.findById('kaopingbiaozhun').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('kaopingbiaozhun');
ManageObj.operationFormPan.findById('kaopingshuoming').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('kaopingshuoming');
ManageObj.operationFormPan.findById('zhidingren').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('zhidingren');
...
ManageObj.doExportExcel = function() {
	var url = "/WEB-ROOT/app/kaohepingdingguanli/kaopingxiangmushezhi.do?flag=doExportExcel";
	window.open(  url );
};
